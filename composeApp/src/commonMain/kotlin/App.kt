...
import ui.screens.gemini_ai.ChatScreen
...
fun App() {
    ...
    val themeState = theme.collectAsState()
    AppTheme(
        mode = themeState.value?.let {
            if (it.lowercase() == "dark") AppTheme.Dark
            else AppTheme.Light } ?: AppTheme.System
    ) {
